        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="relative">
              ...
              <div className="cyber-glass relative p-8">
                <h2 className="text-3xl font-black text-white mb-6 uppercase tracking-[0.2em] cyber-text-glow">IDENTITY_BOOT_RECORDS</h2>
          ...
          {skillsList.length > 0 && (
            ...
            >
              ...
              <div className="cyber-glass relative p-8">
                <h3 className="text-2xl font-black text-white mb-6 border-b border-white/5 pb-2 uppercase tracking-tighter">CORE_SYSTEM_RESOURCES</h3>
